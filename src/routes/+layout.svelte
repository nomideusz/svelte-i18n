...
<header class="site-hd">
	...
	<a class="site-gh" href="https://github.com/nomideusz/svelte-i18n" target="_blank" rel="noopener">
...
<style>
	:global(:root) {
		...
		--success: #34d399;
		/* LocaleSwitcher CSS vars */
		--asini-font-sans: 'Outfit', system-ui, sans-serif;
		--asini-border: rgba(148, 163, 184, 0.15);
		--asini-border-strong: rgba(148, 163, 184, 0.3);
		--asini-surface: #11141b;
		--asini-text: rgba(226, 232, 240, 0.92);
		--asini-accent: #a78bfa;
		--asini-radius-sm: 6px;
	}
	...
	:global([data-scheme='light']) {
		...
		--asini-border: rgba(0, 0, 0, 0.12);
		--asini-border-strong: rgba(0, 0, 0, 0.25);
		--asini-surface: #fafafa;
		--asini-text: rgba(0, 0, 0, 0.87);
		--asini-accent: #7c3aed;
	}
